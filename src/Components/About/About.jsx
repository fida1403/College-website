  ...
  return (
    <div className='about'>
      <div className='about-left'>
        ...
        <img className='play_icon' src={play_icon} alt='' onClick={()=>{SetVideoPlay(true)}} />
      </div>
      <div className='about-right'>
        <h3>ABOUT UNIVERSITY</h3>
        <h2>Nurturing Tomorrow's Leaders Today</h2>
        <p>Embark on a transformative educational journey with our university's comprehensive
            education program's. Our cutting-edge curriculum is designed to empower students with the knowledge,
        ...
        <p>With a focus on innovation, hands-on learning, and personalized mentorship, our programs prepare aspiring educators to make a
            meaningful in classrooms, schools, and communities.
        </p>
